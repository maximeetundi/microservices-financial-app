<template>
  <div class="h-[100dvh] flex bg-base transition-colors duration-300 w-full overflow-hidden">
    <!-- Mobile Overlay -->
    <div 
      v-if="sidebarOpen" 
    ...
    >
      ...
      <!-- Navigation (Same content as dashboard) -->
    ...
    <!-- Main Content -->
    <main class="flex-1 lg:ml-72 transition-all duration-300 h-full flex flex-col overflow-hidden">
      <!-- Mobile Header with Hamburger -->
      <header class="lg:hidden sticky top-0 z-30 bg-slate-100/95 dark:bg-surface/95 backdrop-blur-md border-b border-secondary-200 dark:border-secondary-800 px-4 py-3 flex items-center justify-between flex-shrink-0">
        <button 
      ...
      <!-- Page Content - Full Width & Height for Chat -->
      <!-- REMOVED PADDING HERE compared to dashboard layout -->
