            ...
            <div class="flex flex-wrap items-center gap-4">
              ...
              <div class="w-40">
                ...
                <select v-model="group.currency" 
                  class="w-full px-3 py-2.5 rounded-xl border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white font-mono font-medium focus:ring-2 focus:ring-primary-500 focus:border-transparent">
