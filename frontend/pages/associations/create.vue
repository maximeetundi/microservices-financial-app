      ...
      <div class="p-8">
        <form @submit.prevent="handleSubmit">
          ...
          <div v-if="currentStep === 0" class="space-y-6">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Votre rôle dans l'association</label>
              <select v-model="form.creator_role" 
                      class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all">
              ...
              <p class="text-xs text-gray-500 mt-1">Vous n'êtes pas obligé d'être le président si quelqu'un d'autre assume ce rôle</p>
            </div>
          </div>
