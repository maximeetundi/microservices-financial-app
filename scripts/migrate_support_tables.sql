-- Migration script for Support Service tables
-- Run this script on your crypto_bank database
...
-- Messages table for support conversations
...
-- Insert quick replies for support agents
