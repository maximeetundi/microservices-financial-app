...
func (h *WalletHandler) Deposit(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"sdk_config":     transferResp["sdk_config"],
		"expires_at":     transferResp["expires_at"],
		"aggregator_instance_id": transferResp["aggregator_instance_id"],
		"hot_wallet_id":          transferResp["hot_wallet_id"],
		"provider":       provider,
		"amount":         req.Amount,
		"currency":       wallet.Currency,
